...
describe('CustomButton', () => {
  ...
  it('should show ActivityIndicator when loading is true', () => {
    render(<CustomButton onPress={() => {}} title="Test Button" loading />);
  ...
  it('should apply custom backgroundColor and textColor', () => {
    ...
    render(
      <CustomButton onPress={() => {}} title="Test Button" backgroundColor={backgroundColor} textColor={textColor} />,
    );
    ...
    expect(buttonText.props.style).toContainEqual(expect.objectContaining({ color: textColor }));
  });
